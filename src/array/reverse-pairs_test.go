...
func TestBinarySearch(t *testing.T) {
	nums := []int{3, 3, 4}
	index := binarySearchLastIndexSmallThanTarget(nums, 0, len(nums)-1, 6)
	expected := -1
	if index != expected {
		t.Errorf("expected is [%d], actual is [%d]", expected, index)
	}

	nums = []int{1, 3, 3, 4}
	index = binarySearchLastIndexSmallThanTarget(nums, 0, len(nums)-1, 7)
	expected = 2
	if index != expected {
		t.Errorf("expected is [%d], actual is [%d]", expected, index)
	}
	...
	nums = []int{1, 3, 3, 4}
	index = binarySearchLastIndexSmallThanTarget(nums, 0, len(nums)-1, 4)
	expected = 0
	if index != expected {
		t.Errorf("expected is [%d], actual is [%d]", expected, index)
	}
	...
	nums = []int{1, 3, 3, 4, 4}
	index = binarySearchLastIndexSmallThanTarget(nums, 0, len(nums)-1, 8)
	expected = 2
	if index != expected {
		t.Errorf("expected is [%d], actual is [%d]", expected, index)
	}
	...
	nums = []int{1, 3, 3, 4, 4}
	index = binarySearchLastIndexSmallThanTarget(nums, 0, len(nums)-1, 10)
	expected = 4
	if index != expected {
		t.Errorf("expected is [%d], actual is [%d]", expected, index)
	}

	nums = []int{1, 3, 3, 4, 4, 5}
	index = binarySearchLastIndexSmallThanTarget(nums, 0, len(nums)-1, 10)
	expected = 4
	if index != expected {
		t.Errorf("expected is [%d], actual is [%d]", expected, index)
	...
	nums = []int{2, 3, 3, 4, 4}
	index = binarySearchLastIndexSmallThanTarget(nums, 0, len(nums)-1, 2)
	expected = -1
	if index != expected {
		t.Errorf("expected is [%d], actual is [%d]", expected, index)
	}
